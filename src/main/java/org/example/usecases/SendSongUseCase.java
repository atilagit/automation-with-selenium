...
public class SendSongUseCase {
    ...
    public static final String CAMINHO_DO_ARQUIVO = "C:\\temp\\Divulga nós aí.mp3";
    ...
    public static final String MESSAGE = "Esse áudio também faz parte dos testes. Pode ignorar.";

    public void execute() {
        clickOn(By.xpath(ATTACH_ICON), WAIT_LESS_TIME);
        writeText(CAMINHO_DO_ARQUIVO, By.xpath(DIV_INPUT_FILE), WAIT_SOME_TIME);
        writeText(MESSAGE, By.xpath(FIELD_TO_TEXT_FOR_FILE), WAIT_LESS_TIME);
